...
// A Device represents a device that is managed by the system
type Device struct {
	ID   string `json:"id"`
...
// A Reading represents a value produced by a device at a certain time instant
type Reading struct {
	ID                string `json:"id"`
	Name              string `json:"name"`
...
// Data structure for action data
